...
int left = 37;
int right = 39;
		// 4. If the up arrow is pressed, move the Robot up.
if(keyPressed==up){
	rob.setAngle(0);
	rob.microMove(1);
}
		// 5. If the down arrow is pressed, make the Robot go down.
if(keyPressed==down) {
	rob.setAngle(180);;
	rob.microMove(1);
}
		// 6. If left is pressed, move the Robot left.
if(keyPressed==left) {
	rob.setAngle(270);
	rob.microMove(1);
}
		//7. If right is pressed, move the Robot right
if(keyPressed==right) {
	rob.setAngle(90);
	rob.microMove(1);
}
		...
		// 8. Smile and laugh at the result!
	}
